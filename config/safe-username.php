...
return [
    ...
    /*
    |
    | Overrides, any names in this list
    | will pass the validation Seperate
    | words with commas
    */
    'allowed' => '',
    ...
    /*
    |
    | You can add your own disallowed
    | usernames, which will be merged
    | and checked. Seperate words
    | with commas
    |
    */
    'disallowed' => '',
    ...
    */
    ...
    | or add your own rules above. When
    | upgrading, this list will be overridden with
    | the most current list from: https://github.com/dsignr/disallowed-usernames/
    |
    */
